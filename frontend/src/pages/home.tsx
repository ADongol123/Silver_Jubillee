        ...
        <section className="mb-12">
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Welcome to Gather</h2>
              <p className="text-xl text-muted-foreground">
                Connect with people who share your interests and discover local events in your community.
              </p>
          ...
          <div className="grid gap-6 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-lg mb-4">
                We're here to help you connect with your community. Our support team can guide you through using Gather.
              </p>
            ...
            <div className="grid gap-4 text-lg">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-medium">Join a group based on your interests</p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <div className="rounded-full bg-primary/10 p-2 text-primary">
                ...
                <div>
                  <p className="font-medium">Find and register for local events</p>
                </div>
              </div>
              <div className="flex items-start gap-2">
                <div className="rounded-full bg-primary/10 p-2 text-primary">
                ...
                <div>
                  <p className="font-medium">Discover activities in your neighborhood</p>
                </div>
              </div>
            </div>
          </div>
...
const events = [
  ...
  },
  {
    ...
    description: "Join us to discuss 'The Thursday Murder Club' by Richard Osman.",
    date: "April 18, 2025",
  ...
  },
  {
    ...
    description: "Gentle exercise class designed for seniors of all fitness levels.",
    date: "April 20, 2025",
